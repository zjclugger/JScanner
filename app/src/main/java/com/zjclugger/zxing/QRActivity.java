...
import com.zjclugger.qrcode.utils.ImageUtil;
...
public class QRActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sp_error_correction_level.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                error_correction_level =
                        getResources().getStringArray(R.array.spinarr_error_correction)[position];
            }
        ...
        sp_color_black.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                String str_color_black =
                        getResources().getStringArray(R.array.spinarr_color_black)[position];
        ...
        sp_color_white.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                String str_color_white =
                        getResources().getStringArray(R.array.spinarr_color_white)[position];
    ...
    private void generateQrcodeAndDisplay() {
        ...
        qrcode_bitmap = QRCodeGenerator.create(content, width, height, "UTF-8",
                error_correction_level, margin, color_black, color_white, logoBitmap, 0.2F,
                blackBitmap);
    ...
    private void takePhoto() {
        ...
        if (Build.VERSION.SDK_INT < 24) {
            ...
            imageUri = FileProvider.getUriForFile(QRActivity.this, "com.example.xch" +
                    ".generateqrcode.fileprovider", outputImage);
        }
        // 启动相机程序
