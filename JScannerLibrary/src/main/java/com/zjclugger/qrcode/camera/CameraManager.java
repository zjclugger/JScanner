...
package com.zjclugger.qrcode.camera;
...
import com.zjclugger.qrcode.scanner.CaptureActivityHandler;
...
public final class CameraManager {
    ...
    public CameraManager(Context context, ScannerConfig config) {
...
//    }
    ...
    public void switchFlashLight(CaptureActivityHandler handler) {
        ...
        if (flashMode.equals(Camera.Parameters.FLASH_MODE_TORCH)) {
            ...
            msg.what = ScannerConstants.FLASH_CLOSE;


        } else {
            /*打开闪光灯*/
            parameters.setFlashMode(Camera.Parameters.FLASH_MODE_TORCH);
            msg.what = ScannerConstants.FLASH_OPEN;
        }
