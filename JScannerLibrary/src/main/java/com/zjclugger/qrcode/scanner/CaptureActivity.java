package com.zjclugger.qrcode.scanner;
...
import com.zjclugger.qrcode.camera.CameraManager;
import com.zjclugger.qrcode.utils.ScannerConstants;
import com.zjclugger.qrcode.decode.DecodeImgCallback;
import com.zjclugger.qrcode.decode.DecodeImgThread;
import com.zjclugger.qrcode.decode.ImageUtil;
import com.zjclugger.qrcode.utils.BeepManager;
import com.zjclugger.qrcode.utils.FinishListener;
import com.zjclugger.qrcode.utils.InactivityTimer;
import com.zjclugger.qrcode.view.ViewfinderView;
...
public class CaptureActivity extends AppCompatActivity implements SurfaceHolder.Callback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            config =
                    (ScannerConfig) getIntent().getExtras().get(ScannerConstants.INTENT_ZXING_CONFIG);
        } catch (Exception e) {
    ...
    public void switchFlashImg(int flashState) {
        ...
        if (flashState == ScannerConstants.FLASH_OPEN) {
    ...
    public void handleDecode(Result rawResult) {
        ...
        intent.putExtra(ScannerConstants.CODED_CONTENT, rawResult.getText());
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.flashLightLayout) {
            ...
            startActivityForResult(intent, ScannerConstants.REQUEST_IMAGE);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == ScannerConstants.REQUEST_IMAGE && resultCode == RESULT_OK) {
